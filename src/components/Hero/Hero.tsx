...
const Hero = () => {
    return (
        <section>
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between lg:py-7">
            ...
            <div className='mt-7'>
                <img src={hero_desktop} alt="Square Products" className='hidden sm:block sm:rounded-[20px]'/>
                <MobileCarousel />
            </div>
        </section>
    )
